...
在这样有 instant feedback 的领域，模型在短时间内能够超越人类是必然的。事实上 kernel 领域可能是模型 RSI 最快的部分之一，因为它的结果极端可控，前沿模型在这条链路上通过 kernel development 提升效率，我猜在 openai/anthropic 里面很可能要么已经，要么很快就能够逼近理论能优化到的计算效率上限了。
